    ...
    xhr.onreadystatechange = function () {
        ...
        if (xhr.readyState === 4) {
            if (xhr.status === 200) {
                ...
                if (localStorage && localStorage.getItem('ՐՏ_ver')) {
                    if (new_ver === localStorage.getItem('ՐՏ_ver')) {
                        if (localStorage.getItem('ՐՏ_baselib')) {
                            get_script(null, false, onprogresscallback, onloadedcallback, null, 'ՐՏ_baselib');
                        } else {
                            localStorage.removeItem('ՐՏ_ver');
                            get_script(ՐՏ_baselib, false, onprogresscallback, function () {
                ...
                get_script(null, false, onprogresscallback, onloadedcallback, onfailedcallback, 'ՐՏ_baselib');
            }
        }
    }
